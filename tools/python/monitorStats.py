...
Usage:
  monitorStats plot <file> [--simulation_id=<simid>] [--simulation_phase=<simphase>]
...
Options:
  ...
  --simulation_id=<simid>   An alphanumeric simulation identifier [default: mitgcm50-z75]
  --simulation_phase=<simid>   An alphanumeric simulation identifier [default: prod]
"""
